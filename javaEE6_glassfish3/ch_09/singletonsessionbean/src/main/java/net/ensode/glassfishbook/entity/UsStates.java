/*
 * Для изменения этого шаблона выберите Инструменты (Tools) | Шаблоны (Templates)
 * и откройте шаблон в редакторе.
 */

package net.ensode.glassfishbook.entity;
...
public class UsStates implements Serializable {
    ...
    public boolean equals(Object object) {
        // Предупреждение - этот метод не будет работать, в случае, если идентификатор (id) не задан.
