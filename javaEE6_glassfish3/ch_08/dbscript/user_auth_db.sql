-- Создать базу данных и подключится к ней.
connect 'jdbc:derby://localhost:1527/userauth;create=true';

-- Добавить пользователя в базу данных с учетными данными: username dev, password dev
...
-- Отсоединится от новой созданной базы данных
disconnect;

-- Переподключится к новой созданной базе данных, как пользователь dev
