 ...
 */
@Entity
@Table(name = "US_CITY", catalog = "", schema = "APP")
@NamedQueries({
...
public class UsCity implements Serializable {
    ...
    @NotNull
    @Column(name = "US_CITY_ID", nullable = false)
    private Integer usCityId;
    @Size(max = 30)
    @Column(name = "US_CITY_NM", length = 30)
    ...
    public String toString() {
        return "ru.smitn.entity.UsCity[ usCityId=" + usCityId + " ]";
    }
