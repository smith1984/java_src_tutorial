 ...
 */
@Entity
@Table(name = "ITEM", catalog = "", schema = "APP")
@NamedQueries({
...
public class Item implements Serializable {
    ...
    @Size(max = 100)
    @Column(name = "ITEM_SHORT_DESC", length = 100)
    private String itemShortDesc;
    @Size(max = 500)
    @Column(name = "ITEM_LONG_DESC", length = 500)
    ...
    public String toString() {
        return "ru.smitn.entity.Item[ itemId=" + itemId + " ]";
    }
